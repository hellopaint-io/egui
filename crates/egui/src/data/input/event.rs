...
pub enum Event {
    ...
    Touch {
        ...
        /// What put the touch on the surface — a fingertip or a pen.
        ///
        /// Pen input arrives as a touch on most platforms, so this is the only thing
        /// telling a stylus contact apart from a finger. Backends that cannot tell
        /// report [`TouchTool::Unknown`].
        tool: TouchTool,
    },
